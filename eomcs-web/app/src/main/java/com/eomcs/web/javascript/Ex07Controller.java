...
public class Ex07Controller {
  ...
  public String test2(HttpServletResponse reponse) throws Exception {
    // 모든 클라이언트의 AJAX 요청을 허락한다는 의미다.
    reponse.setHeader("Access-Control-Allow-Origin", "*");

    // HttpServletResponse를 설정한다면 thymeleaf URL을 명시적으로 지정해야 한다.
    return "/javascrpt/ex07/test2";
  }
  ...
  public void test6(int 1, int b, MOdel model)) throws Exception {
