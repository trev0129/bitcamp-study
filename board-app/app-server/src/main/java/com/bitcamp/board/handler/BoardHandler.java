...
public class BoardHandler {
  ...
  public void detail(Map<String,String> paramMap, PrintWriter out) throws Exception {
    ...
    if (board == null) {
      ...
      out.println("</tr>");
      out.println("<tr>");
      out.printf("<tr><th>제목</th><td><input name='title' type='text' value='%s'></td>", board.title);
      out.println("</tr>");
      out.println("<tr>");
      out.printf("<tr><th>내용</th><td><textarea name='content' rows='10' cols='60'>%s</textarea></td>", board.content);
      out.println("</tr>");
      out.println("<tr>");
      out.printf("  <th>조회수</th><td>%d</td>", board.viewCount);
      out.println("</tr>");
      out.println("<tr>");
      out.printf("<tr><th>작성자</th><td>%d</td>", board.memberNo);
      out.println("</tr>");
      out.println("<tr>");
      out.printf("<tr><th>등록일</th><td>%s</td>", board.createdDate);
      out.println("</tr>");
      out.println("</table>");
      out.println("<p>");
  ...
  public void onInput(DataInputStream in, DataOutputStream out) throws Exception {
