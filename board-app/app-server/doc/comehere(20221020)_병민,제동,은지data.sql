...
INSERT INTO `board` (`bno`, `cateno`, `mno`, `title`, `act`, `cont`, `cdt`, `vw_cnt`) VALUES (66, 4, 8, '관리자님 문의ㅐ 드려요', 0,'혹시 제 댓글 한번에 지울 수도 있나요?', '2022-10-16 14:11:39', 0);
...
INSERT INTO `location_review` (`lrno`, `mno`, `pno`, `title`, `cont`, `star`, `cdt`) VALUES (8, 1, 13, '미끄러지지 않게 관리하는 코트같아서 좋았습니다', '가끔 넘어져서 ㅎ ㅏㄴ동안 못하는 경우도 있는데 여기는 그 동안 한 번도 안 다쳤어요', 4.00, '2022-10-20 20:39:13');
